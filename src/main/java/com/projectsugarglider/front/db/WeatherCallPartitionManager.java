...
public class WeatherCallPartitionManager{
    ...
    private void createPartitions(){
        ...
        String sql = """
            CREATE TABLE IF NOT EXISTS weather_call_history_%s
            PARTITION OF weather_call_history
            FOR VALUES IN ('%s')
            """.formatted(ymd,ymd);
